...
public class ContactsServiceImplTest {
    ...
    public void testCreateContacts1() {
        Contacts contacts = new Contacts();
        contacts.setAccountId("123");
        contacts.setDocumentNumber("111");
    ...
    public void testCreate1() {
        ...
        Mockito.when(contactsRepository.findByAccountIdAndDocumentTypeAndDocumentType(Mockito.any(), Mockito.any(), Mockito.anyInt())).thenReturn(addContacts);
    ...
    public void testCreate2() {
        Contacts addContacts = new Contacts(UUID.randomUUID().toString(), UUID.randomUUID().toString(), "name", 1, "12", "10001");
        ArrayList<Contacts> accountContacts = new ArrayList<>();
        Mockito.when(contactsRepository.findByAccountId(Mockito.anyString())).thenReturn(accountContacts);
